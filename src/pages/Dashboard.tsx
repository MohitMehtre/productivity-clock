  ...
  return (
    <div className="min-h-screen selection:bg-zinc-900 selection:text-white dark:selection:bg-zinc-100 dark:selection:text-zinc-900 transition-colors duration-300">
      <div className="max-w-6xl mx-auto px-6 py-20">
        <header className="mb-20 border-b border-zinc-100 dark:border-zinc-800 pb-12 flex flex-col md:flex-row md:items-end justify-between gap-8">
          <div className="flex-1">
            ...
            <h1 className="text-5xl font-bold tracking-tighter mb-6 uppercase text-zinc-900 dark:text-zinc-100">
              Productivity{" "}
              <span className="text-zinc-300 dark:text-zinc-700">Clock.</span>
            </h1>
        ...
        <section className="mb-24">
          <div className="flex items-end justify-between mb-12">
            <div>
              <h2 className="text-xs font-bold uppercase tracking-[0.3em] text-zinc-400 dark:text-zinc-500 mb-2">
                Active Sessions
              </h2>
        ...
        <section className="max-w-md">
          <div className="border border-zinc-200 dark:border-zinc-800 rounded-xl p-8 bg-zinc-50/50 dark:bg-zinc-900/30">
            ...
            <div className="flex flex-col gap-6">
              <input
                ...
                className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded px-4 py-3 text-xs font-medium focus:outline-none focus:border-zinc-900 dark:focus:border-zinc-100 transition-all placeholder:text-zinc-300 dark:placeholder:text-zinc-700 text-zinc-900 dark:text-zinc-100"
              />
