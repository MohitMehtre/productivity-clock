...
export default function TimerCard({ timer }: { timer: Timer }) {
  ...
  return (
    ...
    >
      <div className="absolute top-0 left-0 w-2 h-2 border-t border-l border-zinc-300 dark:border-zinc-700 m-2" />
      <div className="absolute top-0 right-0 w-2 h-2 border-t border-r border-zinc-300 dark:border-zinc-700 m-2" />
      <div className="absolute bottom-0 left-0 w-2 h-2 border-b border-l border-zinc-300 dark:border-zinc-700 m-2" />
      <div className="absolute bottom-0 right-0 w-2 h-2 border-b border-r border-zinc-300 dark:border-zinc-700 m-2" />
      ...
      <div className="bg-zinc-50/50 dark:bg-zinc-900/20 px-6 py-5 flex items-center justify-between">
